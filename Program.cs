...
public void TestGrossTotal()
{
    ...
    var result = calculator.GrossTotal(10, 5);
...
public void TestNetTotal()
{
    var repo = new InventoryRepo();
    var calculator = new Calculator(repo);
    var result = calculator.NetTotal(10, 5);
...
public void TestBulkBuyDiscount()
{
    var repo = new InventoryRepo();
    var calculator = new Calculator(repo);
    var result = calculator.BulkBuyDiscount(99);
...
public void TestBulkBuyDiscount()
{
    ...
    Assert.AreEqual(1, calculator.BulkBuyDiscount(50));
    Assert.AreEqual(0.90, calculator.BulkBuyDiscount(100));
...
public void TestIsStockRunningLow()
{
    ...
    bool result = calculator.IsStockRunningLow(1);
...
public void TestIsStockAvailable()
{
    ...
    Assert.IsTrue(calculator.IsStockAvailable(1, 5));
}
}}}
